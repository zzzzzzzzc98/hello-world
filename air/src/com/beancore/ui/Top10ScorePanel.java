...
public class Top10ScorePanel extends JPanel {
	...
	private void initComponents(MainFrame mainFrame) {
		this.top10ScoreLabel = new JLabel(
				"<html><font size='5'>Top 10 Scores</font></html>");
		...
		Dimension d = new Dimension(Config.POP_UP_SCORE_PANEL_WIDTH,
				Config.POP_UP_SCORE_PANEL_HEIGHT);
