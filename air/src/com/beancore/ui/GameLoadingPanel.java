...
public class GameLoadingPanel extends JPanel {
	...
	private void createLoadingPanel() {
		...
		this.gameLoadingPlaneImgList[0] = new ImageIcon(
				Images.GAME_LOADING_IMG1);
		this.gameLoadingPlaneImgList[1] = new ImageIcon(
				Images.GAME_LOADING_IMG2);
		this.gameLoadingPlaneImgList[2] = new ImageIcon(
				Images.GAME_LOADING_IMG3);
		...
		gameLoadingTextLabel = new JLabel(
				new ImageIcon(this.gameLoadingTextImg));
